...
urlpatterns = [
    ...
    path('reset_password/',
         auth_views.PasswordResetView.as_view(template_name='reset_password_email.html'),
         name='reset_password',
    ),
    ...
    path('reset/<uidb64>/<token>',
         auth_views.PasswordResetConfirmView.as_view(template_name='reset_password_new_password.html'),
